<div class="container-fluid">
    <button class="btn btn-sm btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambah_barang"><i class="fas fa-plus fa-sm"></i>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            '<div class="btn btn-sm btn-success mt-2"><i class="fas fa-search-plus"></i></div>') ?></td>
